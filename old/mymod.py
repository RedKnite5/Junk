import sys, math, random, itertools, hashlib, cPickle
#import timeit, enchant, urllib2, nltk, Tkinter
from Tkinter import *
from bs4 import BeautifulSoup

words = cPickle.load(open("list_of_Eng_words.txt","rb"))
...
def instructions():
	inst = open("mymod_instructions.txt","r")
	print inst.read()
	inst.close()
	return
...
def str_start(begin,string):
	bool = True
	for num,letter in enumerate(begin):
		try:
